# Pet-project-Easy-Eye
  ...
  Работает ли программа с текстом? Да, работает, но во время установки tesseract'a в шаге 1 нужно будет установить дополнительные языковые пакеты. В чистом виде программа распознает только цифры + английский язык.  
